...
[RTL to Gate-Level Simulation Flow](#1-rtl-to-gate-level-simulation-flow)
[Ternary Operator MUX](#2-ternary-operator-mux)
[Bad MUX – Incomplete Sensitivity List](#3-bad-mux--incomplete-sensitivity-list)
[Blocking Assignment](#4-blocking-assignment)
[Blocking vs Non-Blocking Assignments](#5-blocking-vs-non-blocking-assignments)
[Importance of always @(*)](#6-importance-of-always-)
[Simulation-Synthesis Mismatch](#7-simulation-synthesis-mismatch)
[RTL Simulation vs Gate-Level Simulation](#8-rtl-simulation-vs-gate-level-simulation)
[Tools Used](#9-tools-used)
[Key Observations](#10-key-observations)
[Learning Outcomes](#11-learning-outcomes)
