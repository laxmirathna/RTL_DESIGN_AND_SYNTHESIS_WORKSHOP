...
1. [RTL Coding Styles](#1-rtl-coding-styles)
2. [Inferred Latches](#2-inferred-latches)
3. [Labs 1–2 – Incomplete IF Statements](#3-labs-1-2--incomplete-if-statements)
4. [Labs 3–5 – CASE Statements](#4-labs-3-5--case-statements)
5. [Lab 6 – Overlapping CASE Statements](#5-lab-6--overlapping-case-statements)
6. [Synthesis Optimization](#6-synthesis-optimization)
